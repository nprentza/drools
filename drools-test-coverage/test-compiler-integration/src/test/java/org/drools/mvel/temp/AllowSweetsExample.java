...
/*
 * FAI-642 (testScenario_1, testScenario_2, testScenario_3)
 * FAI-687 (testScenario_4, testScenario_5)
 */
...
public class AllowSweetsExample {
    ...
    private String drl1 = "package org.drools.tms.temp; \n " +
    ...
    private String drl2 = "package org.drools.tms.temp; \n " +
            "import " + Person.class.getCanonicalName() + "; \n"  +
            "import " + AllowSweets.class.getCanonicalName() + "; \n"  +
            " " +
            "rule DoNotAllowOnDiet when " +
    ...
    private String drl3 = "package org.drools.tms.temp; \n " +
            "import " + Person.class.getCanonicalName() + "; \n"  +
            "import " + AllowSweets.class.getCanonicalName() + "; \n"  +
            ...
            "end " +
            "\n";
    private String drl4_test = "package org.drools.tms.temp; \n " +
            "import " + Person.class.getCanonicalName() + "; \n"  +
            "import " + AllowSweets.class.getCanonicalName() + "; \n"  +
            "import " + UpdateRestoreCommand.class.getCanonicalName() + "; \n"  +
            "import " + Map.class.getCanonicalName() + "; \n" +
    ...
    private String drl5_test = "package org.drools.tms.temp; \n " +
            "import " + Person.class.getCanonicalName() + "; \n"  +
            "import " + AllowSweets.class.getCanonicalName() + "; \n"  +
            "import " + UpdateRestoreCommand.class.getCanonicalName() + "; \n"  +
            "import " + Map.class.getCanonicalName() + "; \n" +
    ...
    private KieSession getSessionFromString(String drl) {
        ...
        ((SessionConfiguration) ksConf).setBeliefSystemType(  BeliefSystemType.NEWBS ); //BeliefSystemType.NEWBS
