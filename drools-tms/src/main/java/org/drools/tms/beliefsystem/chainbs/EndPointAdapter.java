...
public class EndPointAdapter implements BeliefSystemC {
    ...
    public void processRequest(Object request) {
        //InternalFactHandle ifh = (InternalFactHandle) ep.getFactHandle(results.getInstance());
        if (request!=null){ //ifh!=null
            UpdateRestoreCommand obj = (UpdateRestoreCommand) request;
            obj.update();
